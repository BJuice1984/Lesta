...
export const aboutGameFix = [
  ...
  {
    elementName: 'main',
    elementProblem: 'Для Tablet и Mobile разрешение пропадает главная картинка',
    elementFix: 'Удобнее для пользователя иметь список навигации справа, т.к. при использовании телефона не придётся тянуться в левую часть экрана'
  },
  {
    elementName: 'main',
    elementProblem: 'Фоновая картинка создаёт высокий контраст',
    elementFix: 'Уменьшение яркости/контраста фона сделает сайт приятнее для глаз пользователя'
  },
  {
    elementName: 'main',
    elementProblem: 'Текст "Войти или создать аккаунт" кажется не современным',
    elementFix: 'Весь верхний хедер маленький и союз "или" - лишний. Увеличения текста в хедере улучшит читаемость сайта. Вместо "или" сделать отступ между блоками. Т.о. сайт бне будет напоминать первые сайты с мелким шрифтом'
  },
  {
    elementName: 'main',
